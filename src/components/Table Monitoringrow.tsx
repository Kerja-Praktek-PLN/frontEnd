...
import EditdataMonitoring from './EdtiDataMonitoring';
        ...
        <div className="flex flex-col px-20 pb-10 overflow-x-auto">
         ...
         <div className="grid grid-cols-8 border sm:grid-cols-12">
            ...
            <div className="sm:block p-1.5 xl:p-2.5 border-r col-span-2">
                <p className="text-xs text-black dark:text-white sm:block">Fauzan Aulia</p>
            </div>

            <div className="sm:block p-1.5 xl:p-2.5 border-r">
                <p className="text-xs text-black dark:text-white sm:block">024</p>
            </div>
            ...
            <div className="flex flex-col items-center justify-center col-span-3 border-r">
                <div className="flex justify-between w-full">
                    ...
                    <div className="sm:block p-1.5 xl:p-2.5 border-r w-1/3">
                        <p className="text-xs text-black dark:text-white sm:block">Aman</p>
                    </div>
                    <div className="sm:block p-1.5 xl:p-2.5 flex w-1/3">
                        <p className="text-xs text-black dark:text-white sm:block">Pisang</p>
                    </div>
                </div>
            </div>

            <div className="sm:block p-1.5 xl:p-2.5 border-r">
                <p className="text-xs text-black dark:text-white sm:block">Bawah</p>
            </div>
