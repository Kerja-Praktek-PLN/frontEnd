...
import { dataMVarTransmisi } from "../Data/dataMvarTransmisi";
...
type TabletransmisiProps = {
  data: Array<{ id: number; name: string; link: string, last_update: Date, nama_GI: string  }>
  updateData: (newData: Array<{ id: number; name: string; link: string, lastUpdate: Date, nama_GI: string }>) => void;
};

const Tablevartransmisi: React.FC<TabletransmisiProps> = ({data, updateData}) => {
...
export default Tablevartransmisi