    ...
    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark w-full h-full bg-fixed"
      ...
      <div className="w-full dark:border-strokedark xl:w-1/2 mx-auto max-w-screen-sm bg-white m-15">
        <div className='flex w-full p-5 items-center'>
                ...
                <h2 className="text-2xl text-black dark:text-white sm:text-title-xl2 font-medium mx-auto">
                  Daftar
                </h2>
              </div>
              ...
              <form>
                ...
                <div className="mb-5">
                  <label className="inline-flex items-center">
                    <input type="checkbox" className="form-checkbox h-5 w-5 text-[#333] border border-gray-300 rounded mr-2 ml-10" />
                    <span className="text-[#333] opacity-40 font-medium text-center">Dengan mendaftar, <br/> saya menyetujui Syarat & Ketentuan yang berlaku di PT.PLN</span>
                  </label>
                </div>
