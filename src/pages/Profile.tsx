      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="relative z-20 h-35 md:h-65">
          <img
            ...
            alt="profile cover"
            className="h-full w-full rounded-tl-sm rounded-tr-sm object-center object-fill"
          />
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              ...
              <img src="/src/images/foto.png" alt="profile" className='rounded-full object-cover' />
          ...
          <div className="mt-4">
            <h3 className="mb-1.5 text-2xl font-semibold text-black dark:text-white mt-10">
              Thoriq
            </h3>
            ...
            <div className="mx-auto max-w-180 mt-10">
              ...
              <p className="mt-4.5">
                Kami berkomitmen untuk memberikan pelayanan yang terbaik kepada pelanggannya. 
                ULTG Maros terus berupaya untuk meningkatkan kualitas pelayanannya, 
                sehingga pelanggan dapat menikmati listrik yang andal dan berkualitas..
              </p>
            </div>
